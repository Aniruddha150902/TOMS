...
CREATE TABLE FINE_TICKETS(FINE_ID INTEGER PRIMARY KEY AUTO_INCREMENT,FINE_DESCRIPTION VARCHAR(255) NOT NULL,FINE_AMOUNT 
...
(FINE_ID) ON DELETE CASCADE,OFFICER_ID INTEGER,FOREIGN KEY(OFFICER_ID) REFERENCES TPO(OFFICER_ID) SET NULL,PLACE 
